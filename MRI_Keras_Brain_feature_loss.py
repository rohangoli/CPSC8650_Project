...
for path in os.listdir("/home/joelkik/DataMining/BET_BSE_DATA/files"):
    ...
    labels_brain_feature_loss.append(labels_dict[path])
    

from sklearn.model_selection import train_test_split
x_train, x_test, y_train, y_test = train_test_split(brain_scans, labels_brain_feature_loss, test_size=0.20, random_state=42)
